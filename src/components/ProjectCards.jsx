...
const injectProjectCardStyles = (() => {
  ...
  return () => {
    ...
    style.textContent = `
      ...
      /* The card stretches to its row, and the back face sits in normal flow so its
         write-up sets the height. 4:3 is the floor, not a ceiling: with both faces
         positioned absolutely the box was locked to the ratio and longer copy was
         clipped. */
      .project-flip {
        perspective: 1600px;
        background: none;
