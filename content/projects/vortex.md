...
src (e.g. src="assets/photos/vortex/hero.jpg").
Previous copy is in git: `git show 97065c3:content/projects/vortex.md`
================================================================================
-->

<!-- @page title="Vortex" eyebrow="Architecture · Sculptural monolith" meta="[Role] · [Timeline] · [Context]" back="Architecture" backHref="projects/architecture/" -->
