...
<!-- @card icon="briefcase" title="Tesla — Service Intake Plan" audience="Tesla, Inc. · 2023" -->
...
<!-- @expanded -->
Different cladding logics, different programmatic stacking, different relationships to circulation. The systems-integration drawings work the section down to the catwalk. **Why it matters for PM:** a project that forced me to compare alternatives at the system level — exactly what a roadmap or strategy doc demands.
<!-- /@card -->

<!-- @card icon="target" title="Vortex — Sculptural Monolith" audience="Coastal repurposing · Santa Barbara, CA" -->
...
<!-- @card icon="palette" title="All-American Awaaz — Brand System" audience="Pro-bono · A Cappella org" -->
Brand identity, merch, social grid, and holiday cards for a national South Asian a cappella competition. Hand-lettered graffiti as the year's theme.
<!-- @expanded -->
Output across multiple touchpoints: front and back tee prints for the SF show, a full Instagram grid layout for the org's directors, a fundraiser graphic, a competition tee city graphic, holiday cards, and a lettering-style progression series. **Why it matters for PM:** a project with no brief, only constraints — exactly what early-stage product work feels like.
<!-- /@card -->
...
<!-- @credential value="ARCH" label="ARCH 479 · Design Build (full-scale)" -->
<!-- @credential value="Pro-bono" label="All-American Awaaz brand system" -->
<!-- /@credentials -->
